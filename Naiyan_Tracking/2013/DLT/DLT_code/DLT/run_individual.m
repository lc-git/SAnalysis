...
%    affsig(6) = skew angle
clear all
dataPath = '~/Documents/developer/SAnalysis/Naiyan_Tracking/2013/Data/';
...
case 'basketball';  p = [210 260 40 100 0.0]; %266ballp = [410 332 20 20 0]; %p = [210 260 40 100 0.0]; %132ballp = [378 211 20 20 0];   %96ball: p = [267 217 20 20 0];  
    opt = struct('numsample',1000, 'affsig',[4,4,.005,.000,.001,.000]);    
